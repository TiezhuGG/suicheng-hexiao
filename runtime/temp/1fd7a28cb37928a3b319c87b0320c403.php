<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"/www/hexiao/public/../application/admin/view/paper/add.html";i:1567146265;s:54:"/www/hexiao/application/admin/view/layout/default.html";i:1562338656;s:51:"/www/hexiao/application/admin/view/common/meta.html";i:1562338656;s:53:"/www/hexiao/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-papername" class="form-control" name="row[papername]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group" id="chargenum">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-chargenum" class="form-control" name="row[chargenum]" type="number" value="0">
        </div>
    </div>
