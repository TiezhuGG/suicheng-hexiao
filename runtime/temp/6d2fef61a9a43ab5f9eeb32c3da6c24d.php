<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"/www/hexiao/public/../application/admin/view/vip/add.html";i:1566454331;s:54:"/www/hexiao/application/admin/view/layout/default.html";i:1562338656;s:51:"/www/hexiao/application/admin/view/common/meta.html";i:1562338656;s:53:"/www/hexiao/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Aduitman'); ?>:</label>
        <div class="col-xs-12 col-sm-8">

            <div class="radio">
                <?php if(is_array($adutimanList) || $adutimanList instanceof \think\Collection || $adutimanList instanceof \think\Paginator): if( count($adutimanList)==0 ) : echo "" ;else: foreach($adutimanList as $key=>$vo): ?>
                <label for="row[aduitman]-<?php echo $key; ?>"><input id="row[aduitman]-<?php echo $key; ?>" name="row[aduitman]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"0"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
