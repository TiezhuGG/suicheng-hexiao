<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"/www/hexiao/public/../application/admin/view/activity/edit.html";i:1567997446;s:54:"/www/hexiao/application/admin/view/layout/default.html";i:1562338656;s:51:"/www/hexiao/application/admin/view/common/meta.html";i:1562338656;s:53:"/www/hexiao/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-activityname" data-rule="required" class="form-control" name="row[activityname]" type="text" value="<?php echo htmlentities($row['activityname']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-activityimages" class="form-control" size="50" name="row[activityimages]" type="text" value="<?php echo htmlentities($row['activityimages']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-organizers" class="form-control" name="row[organizers]" type="text" value="<?php echo htmlentities($row['organizers']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-block" class="form-control" name="row[block]" type="text" value="<?php echo htmlentities($row['block']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Public_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-public_name" class="form-control" name="row[public_name]" type="text" value="<?php echo htmlentities($row['public_name']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-public_desc" class="form-control" name="row[public_desc]" type="text" value="<?php echo htmlentities($row['public_desc']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-public_logo" class="form-control" size="50" name="row[public_logo]" type="text" value="<?php echo htmlentities($row['public_logo']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-rqcode" class="form-control" size="50" name="row[rqcode]" type="text" value="<?php echo htmlentities($row['rqcode']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-views" class="form-control"  name="row[views]" type="text" value="<?php echo htmlentities($row['views']); ?>">
        </div>
    </div>
    <div id="x" class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Navigation_x'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-navigation_x" class="form-control" name="row[navigation_x]" type="text" value="<?php echo htmlentities($row['navigation_x']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-navigation_y" class="form-control" name="row[navigation_y]" type="text" value="<?php echo htmlentities($row['navigation_y']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" data-multiple="true">
            <select  multiple="multiple" id="c-audit_id"   class="form-control selectpicker"  name="row[audit_id][]">
                ...
                <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['audit_id'])?$row['audit_id']:explode(',',$row['audit_id']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-signuptime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[signuptime]" type="text" value="<?php echo $row['signuptime']?datetime($row['signuptime']):''; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Signupendtime'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-signupendtime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[signupendtime]" type="text" value="<?php echo $row['signupendtime']?datetime($row['signupendtime']):''; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-auditendtime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[auditendtime]" type="text" value="<?php echo $row['auditendtime']?datetime($row['auditendtime']):''; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Statrtime'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-statrtime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[statrtime]" type="text" value="<?php echo $row['statrtime']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-signupnum" class="form-control" name="row[signupnum]" type="number" value="<?php echo htmlentities($row['signupnum']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select  id="c-notcharge" data-rule="required" class="form-control selectpicker" name="row[notcharge]">
                ...
                <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['notcharge'])?$row['notcharge']:explode(',',$row['notcharge']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="form-group" id="notcharge" style="display:none;">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-charge" class="form-control" name="row[charge]" type="number" value="<?php echo $row['charge']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
                ...
                <label for="row[notaudit]-<?php echo $key; ?>"><input id="row[notaudit]-<?php echo $key; ?>" name="row[notaudit]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['notaudit'])?$row['notaudit']:explode(',',$row['notaudit']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-signupmust" class="editor " rows="5" name="row[signupmust]" cols="50"><?php echo htmlentities($row['signupmust']); ?></textarea>
        </div>
    </div>
