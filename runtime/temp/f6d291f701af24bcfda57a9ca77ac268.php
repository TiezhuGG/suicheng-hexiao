<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"/www/hexiao/public/../application/admin/view/paper/form.html";i:1567250803;s:54:"/www/hexiao/application/admin/view/layout/default.html";i:1562338656;s:51:"/www/hexiao/application/admin/view/common/meta.html";i:1562338656;s:53:"/www/hexiao/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-charge" data-rule="required" class="form-control" name="row[charge]">
    ...
    <div class="form-group" id="chargenum">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-chargenum" class="form-control" data-rule="required" name="row[chargenum]" type="number" value="<?php echo htmlentities($row['chargenum']); ?>">
        </div>
    </div>
</form>
